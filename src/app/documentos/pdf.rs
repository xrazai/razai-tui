...
mod tests {
    ...
    fn writes_checklist_pdf_with_page_breaks() {
        let tecido = TecidoRecord {
            ...
            preco_atacado: None,
            preco_varejo: None,
            custo_override_count: 0,
            preco_atacado_override_count: 0,
            preco_varejo_override_count: 0,
            custo_override_min: None,
            custo_override_max: None,
            preco_atacado_override_min: None,
            preco_atacado_override_max: None,
            preco_varejo_override_min: None,
            preco_varejo_override_max: None,
        ...
        let vinculos = (0..30)
            .map(|index| VinculoRecord {
                ...
                custo_override: None,
                custo_efetivo: None,
                tecido_preco_atacado: None,
                tecido_preco_varejo: None,
                preco_atacado_override: None,
                preco_varejo_override: None,
                preco_atacado_efetivo: None,
                preco_varejo_efetivo: None,
